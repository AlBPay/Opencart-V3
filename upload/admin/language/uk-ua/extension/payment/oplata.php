...
$_['text_payment_details'] = 'Платіжні реквізити Alliance bank';
$_['text_fondy_order_id'] = 'ID замовлення Alliance bank';
...
$_['entry_redirect'] = 'Перенаправлення на Alliance bank';
...
// Tooltip
$_['tooltip_entry_status'] = 'Відображати Alliance bank у списку платіжних методів на сайті';
$_['tooltip_entry_environment'] = 'Оберіть \'Test\' для тестування Alliance bank';
$_['tooltip_entry_merchant'] = 'Можна знайти у порталі Alliance bank (розділ \'Налаштування мерчанта\' → \'Технічні налаштування\')';
$_['tooltip_entry_secretkey'] = $_['tooltip_entry_merchant'];
$_['tooltip_entry_process_payment_type'] = 'Оберіть, де саме буде відображатись платіжна сторінка Alliance bank';
$_['tooltip_entry_payment_type'] = 'При виборі \'' . $_['entry_preauth_type'] . '\' сума замовлення блокується на картці платника';
$_['tooltip_field_payment_id'] = 'Унікальний ідентифікатор платежу, присвоєний платіжним шлюзом Alliance bank';
$_['tooltip_btn_preauth_reverse'] = 'Доступно тільки на всю суму замовлення';

$_['help_entry_environment'] = '<i class="fa fa-info-circle" aria-hidden="true"></i> Вам присвоєно <a href="https://documentation.albpay.io/docs/page/2/">тестовий</a> <em>' . $_['entry_merchant'] . '</em> і <em>' . $_['entry_secretkey'] . '</em>';
?>