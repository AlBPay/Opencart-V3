...
$_['text_oplata'] = '<a onclick="window.open(\'https://fondy.io\');"><img src="view/image/payment/oplata.png" alt="Alliance bank" title="Alliance bank" style="border: 1px solid #EEEEEE;" /></a>';
$_['text_success'] = 'Настройки модуля обновлены!';
$_['text_pay'] = 'Alliance bank';
...
$_['text_payment_details'] = 'Платёжные реквизиты Alliance bank';
$_['text_fondy_order_id'] = 'ID заказа Alliance bank';
...
$_['entry_redirect'] = 'Перенаправление на Alliance bank';
...
// Tooltip
$_['tooltip_entry_status'] = 'Отображать Alliance bank в списке платежных методов на сайте';
$_['tooltip_entry_environment'] = 'Выберите \'Test\' для тестирования Alliance bank';
$_['tooltip_entry_merchant'] = 'Можно найти в портале Alliance bank (раздел \'Настройки мерчанта\' → \'Технические\')';
$_['tooltip_entry_secretkey'] = 'Можно найти в портале Alliance bank (раздел \'Настройки мерчанта\' → \'Технические\')';
$_['tooltip_entry_process_payment_type'] = 'Выберите где будет отображаться платежная страница Alliance bank';
$_['tooltip_entry_payment_type'] = 'При выборе \'' . $_['entry_preauth_type'] . '\' сумма заказа блокируется на карте плательщика';
$_['tooltip_field_payment_id'] = 'Уникальный идентификатор платежа, присвоенный платежным шлюзом Alliance bank';
$_['tooltip_btn_preauth_reverse'] = 'Доступно только на всю сумму заказа';

$_['help_entry_environment'] = '<i class="fa fa-info-circle" aria-hidden="true"></i> Вам присвоен <a href="https://documentation.albpay.io/docs/page/2/">тестовый</a> <em>' . $_['entry_merchant'] . '</em> и <em>' . $_['entry_secretkey'] . '</em>';
?>